        ...
        <div className="min-h-screen bg-[#020617] text-slate-200 font-sans pb-20">
            <header className="fixed top-0 left-0 right-0 h-16 bg-[#020617]/90 backdrop-blur-md border-b border-slate-800 z-50 flex items-center justify-between px-6 md:px-12">
                <div className="flex items-center gap-3">
                    ...
                    <div className="hidden md:block">
                        <h1 className="font-bold text-white text-sm md:text-base leading-tight">Classes, Structures and Files</h1>
            ...
            <section id="intro" className="pt-32 pb-16 px-6 md:px-12 max-w-7xl mx-auto">
                ...
                <h1 className="text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-white mb-6 leading-tight">
                    Classes, Structures and Files
                </h1>
                <p className="text-xl text-slate-400 leading-relaxed max-w-3xl mb-12">
                    Welcome to Unit 3, Lecture 3. This interactive note will cover the foundational concepts for this topic.
                </p>
            </section>
            ...
            <section id="topics" className="px-6 md:px-12 max-w-7xl mx-auto mb-24">
                ...
                <TheoryCard title="Detailed Lecture Content" icon={<BookOpen size={18} />} variant="purple">
                    ...
                    <div className="mb-8 p-6 bg-slate-900/50 border border-slate-700 rounded-xl">
                        <h3 className="text-xl font-bold text-blue-300 mb-3 border-b border-slate-800 pb-2">Classes and file operations</h3>
                        <p className="text-slate-300 leading-relaxed text-sm md:text-base">Objects of a class can be written directly to a binary file using `write((char*)&amp;obj, sizeof(obj))`. However, this is extremely dangerous if the class contains pointers or dynamic memory (like `std::string`), as only the pointer address is saved, not the actual data.</p>
                    </div>
                    <div className="mb-8 p-6 bg-slate-900/50 border border-slate-700 rounded-xl">
                        <h3 className="text-xl font-bold text-blue-300 mb-3 border-b border-slate-800 pb-2">Structures and file operation</h3>
                        <p className="text-slate-300 leading-relaxed text-sm md:text-base">Plain Old Data (POD) structures are perfectly suited for binary file operations. An entire structure containing fixed-size arrays and primitive types can be dumped to disk and read back instantly using binary `read` and `write` functions, serving as a simple database.</p>
                    </div>
                </TheoryCard>
            </section>
        </div>
