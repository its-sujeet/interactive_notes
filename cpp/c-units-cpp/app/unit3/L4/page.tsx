        ...
        <div className="min-h-screen bg-[#020617] text-slate-200 font-sans pb-20">
            <header className="fixed top-0 left-0 right-0 h-16 bg-[#020617]/90 backdrop-blur-md border-b border-slate-800 z-50 flex items-center justify-between px-6 md:px-12">
                <div className="flex items-center gap-3">
                    ...
                    <div className="hidden md:block">
                        <h1 className="font-bold text-white text-sm md:text-base leading-tight">Manager Functions Basics</h1>
            ...
            <section id="intro" className="pt-32 pb-16 px-6 md:px-12 max-w-7xl mx-auto">
                ...
                <h1 className="text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-white mb-6 leading-tight">
                    Manager Functions Basics
                </h1>
                <p className="text-xl text-slate-400 leading-relaxed max-w-3xl mb-12">
                    Welcome to Unit 3, Lecture 4. This interactive note will cover the foundational concepts for this topic.
                </p>
            </section>
            ...
            <section id="topics" className="px-6 md:px-12 max-w-7xl mx-auto mb-24">
                ...
                <TheoryCard title="Detailed Lecture Content" icon={<BookOpen size={18} />} variant="purple">
                    ...
                    <div className="mb-8 p-6 bg-slate-900/50 border border-slate-700 rounded-xl">
                        <h3 className="text-xl font-bold text-blue-300 mb-3 border-b border-slate-800 pb-2">Manager functions (constructors and destructor)</h3>
                        <p className="text-slate-300 leading-relaxed text-sm md:text-base">Constructors and destructors are special manager functions. Constructors are invoked automatically when an object is created to initialize memory and state. Destructors are invoked when an object goes out of scope to release resources. They have no return types.</p>
                    </div>
                    <div className="mb-8 p-6 bg-slate-900/50 border border-slate-700 rounded-xl">
                        <h3 className="text-xl font-bold text-blue-300 mb-3 border-b border-slate-800 pb-2">Default constructor</h3>
                        <p className="text-slate-300 leading-relaxed text-sm md:text-base">A constructor that takes no arguments is a default constructor. If no constructors are defined by the programmer, the compiler generates a default one. It is essential when creating arrays of objects, as the array instantiation requires calling the default constructor for every element.</p>
                    </div>
                    <div className="mb-8 p-6 bg-slate-900/50 border border-slate-700 rounded-xl">
                        <h3 className="text-xl font-bold text-blue-300 mb-3 border-b border-slate-800 pb-2">Destructors</h3>
                        <p className="text-slate-300 leading-relaxed text-sm md:text-base">A destructor has the same name as the class preceded by a tilde (`~`). It cannot take arguments and cannot be overloaded. It is responsible for cleaning up resources, closing files, and freeing dynamically allocated memory (using `delete`) before the object is destroyed.</p>
                    </div>
                </TheoryCard>
            </section>
        </div>
