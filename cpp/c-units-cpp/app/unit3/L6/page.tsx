        ...
        <div className="min-h-screen bg-[#020617] text-slate-200 font-sans pb-20">
            <header className="fixed top-0 left-0 right-0 h-16 bg-[#020617]/90 backdrop-blur-md border-b border-slate-800 z-50 flex items-center justify-between px-6 md:px-12">
                <div className="flex items-center gap-3">
                    ...
                    <div className="hidden md:block">
                        <h1 className="font-bold text-white text-sm md:text-base leading-tight">Copy Constructors & Initializer Lists</h1>
                        <p className="text-[10px] text-slate-500 uppercase tracking-widest">Unit 3 • Lecture 6</p>
                    </div>
                </div>
            ...
            <section id="intro" className="pt-32 pb-16 px-6 md:px-12 max-w-7xl mx-auto">
                ...
                <h1 className="text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-white mb-6 leading-tight">
                    Copy Constructors & Initializer Lists
                </h1>
                <p className="text-xl text-slate-400 leading-relaxed max-w-3xl mb-12">
                    Welcome to Unit 3, Lecture 6. This interactive note will cover the foundational concepts for this topic.
                </p>
            </section>
            ...
            <section id="topics" className="px-6 md:px-12 max-w-7xl mx-auto mb-24">
                ...
                <TheoryCard title="Detailed Lecture Content" icon={<BookOpen size={18} />} variant="purple">
                    ...
                    <div className="mb-8 p-6 bg-slate-900/50 border border-slate-700 rounded-xl">
                        <h3 className="text-xl font-bold text-blue-300 mb-3 border-b border-slate-800 pb-2">Copy constructor</h3>
                        <p className="text-slate-300 leading-relaxed text-sm md:text-base">A copy constructor initializes a new object as a copy of an existing object of the same class (`ClassName(const ClassName &amp;obj)`). It is invoked during pass-by-value, return-by-value, and direct assignment. If a class manages dynamic memory, a custom Deep Copy constructor is strictly mandatory.</p>
                    </div>
                    <div className="mb-8 p-6 bg-slate-900/50 border border-slate-700 rounded-xl">
                        <h3 className="text-xl font-bold text-blue-300 mb-3 border-b border-slate-800 pb-2">Initializer lists</h3>
                        <p className="text-slate-300 leading-relaxed text-sm md:text-base">Initializer lists are used in constructors to initialize member variables before the constructor body executes. Syntax: `ClassName(int a) : memberA(a) &#123;&#125;`. It is the *only* way to initialize `const` members, reference members, and base class constructors.</p>
                    </div>
                </TheoryCard>
            </section>
        </div>
