        ...
        <div className="min-h-screen bg-[#020617] text-slate-200 font-sans pb-20">
            <header className="fixed top-0 left-0 right-0 h-16 bg-[#020617]/90 backdrop-blur-md border-b border-slate-800 z-50 flex items-center justify-between px-6 md:px-12">
                <div className="flex items-center gap-3">
                    ...
                    <div className="hidden md:block">
                        <h1 className="font-bold text-white text-sm md:text-base leading-tight">Ambiguities & Virtual Base Class</h1>
            ...
            <section id="intro" className="pt-32 pb-16 px-6 md:px-12 max-w-7xl mx-auto">
                ...
                <h1 className="text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-white mb-6 leading-tight">
                    Ambiguities & Virtual Base Class
                </h1>
                <p className="text-xl text-slate-400 leading-relaxed max-w-3xl mb-12">
                    Welcome to Unit 4, Lecture 5. This interactive note will cover the foundational concepts for this topic.
                </p>
            </section>
            ...
            <section id="topics" className="px-6 md:px-12 max-w-7xl mx-auto mb-24">
                ...
                <TheoryCard title="Detailed Lecture Content" icon={<BookOpen size={18} />} variant="purple">
                    ...
                    <div className="mb-8 p-6 bg-slate-900/50 border border-slate-700 rounded-xl">
                        <h3 className="text-xl font-bold text-blue-300 mb-3 border-b border-slate-800 pb-2">Resolving ambiguities in inheritance</h3>
                        <p className="text-slate-300 leading-relaxed text-sm md:text-base">In multiple inheritance, if two base classes have a function with the same name, calling it from the derived class is ambiguous. This is resolved using the scope resolution operator to explicitly specify the base class: `object.BaseClass::functionName();`.</p>
                    </div>
                    <div className="mb-8 p-6 bg-slate-900/50 border border-slate-700 rounded-xl">
                        <h3 className="text-xl font-bold text-blue-300 mb-3 border-b border-slate-800 pb-2">Virtual base class</h3>
                        <p className="text-slate-300 leading-relaxed text-sm md:text-base">The Diamond Problem occurs when two classes B and C inherit from A, and D inherits from both B and C. D ends up with two copies of A. Declaring A as a `virtual` base class for B and C ensures that D only inherits a single, shared instance of A.</p>
                    </div>
                </TheoryCard>
            </section>
        </div>
