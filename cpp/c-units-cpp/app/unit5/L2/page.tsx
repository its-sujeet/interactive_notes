        ...
        <div className="min-h-screen bg-[#020617] text-slate-200 font-sans pb-20">
            <header className="fixed top-0 left-0 right-0 h-16 bg-[#020617]/90 backdrop-blur-md border-b border-slate-800 z-50 flex items-center justify-between px-6 md:px-12">
                <div className="flex items-center gap-3">
                    ...
                    <div className="hidden md:block">
                        <h1 className="font-bold text-white text-sm md:text-base leading-tight">Binding & Compile Time Polymorphism</h1>
            ...
            <section id="intro" className="pt-32 pb-16 px-6 md:px-12 max-w-7xl mx-auto">
                <div className="inline-flex items-center gap-2 bg-blue-900/20 border border-blue-500/30 text-blue-300 px-3 py-1 rounded-full text-xs font-bold mb-6">
                    <Terminal size={14} /> Dynamic Memory Management and Polymorphism
                </div>
                <h1 className="text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-white mb-6 leading-tight">
                    Binding & Compile Time Polymorphism
                </h1>
                <p className="text-xl text-slate-400 leading-relaxed max-w-3xl mb-12">
                    Welcome to Unit 5, Lecture 2. This interactive note will cover the foundational concepts for this topic.
                </p>
            </section>
            ...
            <section id="topics" className="px-6 md:px-12 max-w-7xl mx-auto mb-24">
                ...
                <TheoryCard title="Detailed Lecture Content" icon={<BookOpen size={18} />} variant="purple">
                    ...
                    <div className="mb-8 p-6 bg-slate-900/50 border border-slate-700 rounded-xl">
                        <h3 className="text-xl font-bold text-blue-300 mb-3 border-b border-slate-800 pb-2">Compile and run time polymorphism</h3>
                        <p className="text-slate-300 leading-relaxed text-sm md:text-base">Compile-time (static) polymorphism is achieved through function overloading and operator overloading, where the compiler knows the exact function to call. Run-time (dynamic) polymorphism is achieved through virtual functions and base-class pointers, where the function call is resolved during execution based on the actual object type.</p>
                    </div>
                    <div className="mb-8 p-6 bg-slate-900/50 border border-slate-700 rounded-xl">
                        <h3 className="text-xl font-bold text-blue-300 mb-3 border-b border-slate-800 pb-2">Early binding and late binding</h3>
                        <p className="text-slate-300 leading-relaxed text-sm md:text-base">Early binding (static binding) resolves function calls at compile-time based on the pointer type. Late binding (dynamic binding) delays the resolution until runtime, looking up the Virtual Table (V-Table) to call the function corresponding to the actual object the pointer refers to.</p>
                    </div>
                </TheoryCard>
            </section>
        </div>
