        ...
        <div className="min-h-screen bg-[#020617] text-slate-200 font-sans pb-20">
            <header className="fixed top-0 left-0 right-0 h-16 bg-[#020617]/90 backdrop-blur-md border-b border-slate-800 z-50 flex items-center justify-between px-6 md:px-12">
                <div className="flex items-center gap-3">
                    ...
                    <div className="hidden md:block">
                        <h1 className="font-bold text-white text-sm md:text-base leading-tight">Run Time Polymorphism</h1>
            ...
            <section id="intro" className="pt-32 pb-16 px-6 md:px-12 max-w-7xl mx-auto">
                ...
                <p className="text-xl text-slate-400 leading-relaxed max-w-3xl mb-12">
                    Welcome to Unit 5, Lecture 3. This interactive note will cover the foundational concepts for this topic.
                </p>
            </section>
            ...
            <section id="topics" className="px-6 md:px-12 max-w-7xl mx-auto mb-24">
                ...
                <TheoryCard title="Detailed Lecture Content" icon={<BookOpen size={18} />} variant="purple">
                    ...
                    <div className="mb-8 p-6 bg-slate-900/50 border border-slate-700 rounded-xl">
                        <h3 className="text-xl font-bold text-blue-300 mb-3 border-b border-slate-800 pb-2">Virtual functions</h3>
                        <p className="text-slate-300 leading-relaxed text-sm md:text-base">A virtual function is declared in a base class using the `virtual` keyword and redefined in a derived class. When accessed through a base class pointer/reference, the compiler uses late binding to ensure the derived class&apos;s overridden function is executed, enabling true polymorphism.</p>
                    </div>
                    <div className="mb-8 p-6 bg-slate-900/50 border border-slate-700 rounded-xl">
                        <h3 className="text-xl font-bold text-blue-300 mb-3 border-b border-slate-800 pb-2">Pure virtual functions</h3>
                        <p className="text-slate-300 leading-relaxed text-sm md:text-base">A pure virtual function is declared by assigning `0` to it: `virtual void display() = 0;`. It has no body in the base class. It forces any derived class to provide an implementation, serving as a strict interface contract.</p>
                    </div>
                </TheoryCard>
            </section>
        </div>
