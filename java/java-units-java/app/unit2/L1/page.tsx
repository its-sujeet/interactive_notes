            ...
            <div className="min-h-screen bg-[#020617] text-slate-200 font-sans pb-20">
                ...
                <header className="fixed top-0 left-0 right-0 h-16 bg-[#020617]/80 backdrop-blur-xl border-b border-slate-800/50 z-50 flex items-center justify-between px-6 md:px-12 shadow-sm">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="font-bold text-white text-sm md:text-base leading-tight tracking-wide">Basic Loops</h1>
                            <p className="text-[10px] text-orange-400 font-bold uppercase tracking-widest mt-0.5">Unit 2 • Lecture 1</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-4">
                ...
                <main className="pt-24 px-6 md:px-12 max-w-7xl mx-auto">
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <h2 className="text-xl font-bold text-white">Basic Loops</h2>
                    ...
                    <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-8 mb-8">
                        ...
                        <ul className="list-disc list-inside text-slate-300 space-y-2">
                            <li>Working with for loop, while loop</li>
                        </ul>
                    </div>
